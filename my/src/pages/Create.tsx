    ...
    <div className="w-full h-screen bg-gradient-to-r from-[#000000] to-[#0A0903] text-white p-2">
      ...
      <div className="w-full h-5/6 flex justify-center items-center  ">
        <form
          ...
          className="flex flex-col gap-5 w-4/6 sm:2/6 md:w-2/6 lg:w-3/6 xl:w-[36%]"
        >
          <h1 className="scroll-m-20 text-[1.5rem] sm:text-3xl font-extrabold tracking-tight lg:text-5xl md:mb-3 text-center">
            Enter Product Details
          </h1>
          {/* register your input into the hook by invoking the "register" function */}
          <input
            {...register("name", { required: true, minLength: 5 })}
            className="outline-none px-3 py-1.5 rounded-md text-zinc-950 placeholder:text-sm"
          ...
          <input
            ...
            className="outline-none px-3 py-1.5 rounded-md text-zinc-950 text-sm"
